...
from kim_nequip.nn import RescaleOutput, GraphModuleMixin, PerSpeciesScaleShift
from kim_nequip.data import AtomicDataDict, AtomicDataset
...
def GlobalRescale(
    ...
    if initialize:
        ...
        if len(str_names) > 0:
            computed_stats = [torch.tensor(1.0), torch.tensor([0.0])]
